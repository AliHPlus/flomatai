...
# Run a local workflow from workflows/ directory
flomatai workflow planning
flomatai workflow planning --file docs.md
flomatai workflow planning --resume <run-id>
flomatai workflow implementation --file plan.md
